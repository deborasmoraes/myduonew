...
Quando você realiza o cadastro com nosso aplicativo, como parte do processo de compra e venda, coletamos as informações pessoais que você nos dá tais como: nome, e-mail e localização. 
...
Se após você nos fornecer seus dados, você mudar de ideia, você pode retirar o seu consentimento para que possamos entrar em contato, para a coleção de dados contínua, uso ou divulgação de suas informações, a qualquer momento, entrando em contato conosco em contato@myduo.com ou nos enviando uma correspondência em: MyDuo R. Duque de Caxias, 830 - Centro, Timbó - SC 
<Text style={styles.nome2}>
SEÇÃO 3 - DIVULGAÇÃO </Text>

Podemos divulgar suas informações pessoais caso sejamos obrigados pela lei para fazê-lo ou se você violar nossos Termos de Serviço. 
<Text style={styles.nome2}>
SEÇÃO 4 - SERVIÇOS DE TERCEIROS </Text>
...
<Text style={styles.nome2}>
SEÇÃO 6 - ALTERAÇÕES PARA ESSA POLÍTICA DE PRIVACIDADE </Text>
